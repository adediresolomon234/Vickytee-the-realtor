...
export function SiteFooter() {
  return <footer>
    ...
    <div className="footer-legal"><p>© {new Date().getFullYear()} Vickytee the Realtor. All rights reserved.</p><p>REALTOR® is a registered trademark of the National Association of REALTORS®. Information is deemed reliable but not guaranteed. Equal Housing Opportunity.</p><Link href="/admin">Admin</Link></div>
  </footer>;
}
