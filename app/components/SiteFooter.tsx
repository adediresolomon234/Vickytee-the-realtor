...
export function SiteFooter() {
  return <footer>
    ...
    <nav className="footer-disclosures" aria-label="Texas real estate disclosures">
      <Link href="/about/broker-information#consumer-protection-notice">Texas Real Estate Commission Consumer Protection Notice</Link>
      <Link href="/about/broker-information#information-about-brokerage-services">Texas Real Estate Commission Information About Brokerage Services (IABS)</Link>
    </nav>
